input <- readLines('~/workspace-private/adventofcode/adventofcode2015/input08.txt')
...
sum(stri_length(stri_escape_unicode(input))) + 2*length(input) - sum(stri_length(input))
